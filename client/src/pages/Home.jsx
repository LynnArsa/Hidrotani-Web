  ...
  return (
    <div>
      ...
      <section className="bg-gray-100 py-12 md:py-20">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-white p-4 rounded-lg shadow flex flex-col items-center min-w-[200px] max-w-[300px]">
              <img
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto bg-gradient-to-r from-primary to-secondary p-6 md:p-8 rounded-lg flex flex-col md:flex-row items-center justify-between">
      ...
      <section className="bg-gray-100 py-12 md:py-20">
        <div className="container mx-auto text-center">
          ...
          <div className="relative flex items-center justify-center md:space-x-4">
            <button
              onClick={handlePrev}
              className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-primary text-white rounded-full p-3 md:p-4"
            >
              &larr;
            </button>
            ...
            <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
              {testimonials
                ...
                .map((testimonial, index) => (
                  <div
                    key={index}
                    className="bg-white p-4 md:p-8 rounded-lg shadow-lg w-full md:w-80 h-72 flex-none flex flex-col justify-between"
                  >
            ...
            <button
              onClick={handleNext}
              className=" absolute right-0 top-1/2 transform -translate-y-1/2 bg-primary text-white rounded-full p-3 md:p-4"
            >
              &rarr;
            </button>
          </div>
      ...
      {/* Section 6: Products */}
      <section className="bg-gradient-to-r from-primary to-secondary p-6 md:p-24">
        <div className="container mx-auto text-center">
          ...
          <div className="flex overflow-x-auto space-x-4 md:space-x-8 pb-4">
            ...
            <div className="bg-white min-w-[200px] md:min-w-[300px] p-4 md:p-6 rounded-lg shadow-lg text-left">
              ...
              <button
                className="bg-green-600 text-white px-4 py-2 mt-4 rounded-lg w-full hover:bg-green-700 transition duration-300"
                onClick={handleBuyNowClick}
              >
                Beli Sekarang
              </button>
            ...
            <div className="bg-white min-w-[200px] md:min-w-[300px] p-4 md:p-6 rounded-lg shadow-lg text-left">
              <img
                src="/src/assets/nutrisi-hidroponik.jpg"
                alt="Produk 2"
                className="mx-auto mb-2 md:mb-4 w-full h-32 md:h-48 object-cover rounded-md"
              />
              <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2">
            ...
            <div className="bg-white min-w-[200px] md:min-w-[300px] p-4 md:p-6 rounded-lg shadow-lg text-left">
              <img
                src="/src/assets/instalasi-hidroponik.jpg"
                alt="Produk 4"
                className="mx-auto mb-2 md:mb-4 w-full h-32 md:h-48 object-cover rounded-md"
              />
              <h3 className="text-lg md:text-xl font-bold mb-1 md:mb-2">
